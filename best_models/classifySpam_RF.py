# -*- coding: utf-8 -*-
"""
Random Forest Classifier with Configurable Preprocessing
...
def _create_pipeline():
    """Create Random Forest pipeline with configurable preprocessing"""
    steps = []
    ...
    # 3. Scaling (optional - usually not needed for trees)
