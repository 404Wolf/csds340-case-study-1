# -*- coding: utf-8 -*-
"""
Logistic Regression Classifier with Configurable Preprocessing
...
SCALING_METHOD = 'standard'      # Options: 'none', 'standard', 'robust', 'minmax'
# ======================================================


def _create_pipeline():
    """Create Logistic Regression pipeline with configurable preprocessing"""
    steps = []
    ...
    # 3. Scaling (IMPORTANT for LogReg - sensitive to feature scales)
    ...
    # 5. Model with L2 regularization
...
def aucCV(features, labels):
    ...
    scores = cross_val_score(model, features, labels, cv=cv, scoring="roc_auc", n_jobs=-1)
    return scores
