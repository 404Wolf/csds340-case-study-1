...
spam = labels == 1
axes[1].scatter(features_pca[~spam, 0], features_pca[~spam, 1], 
                c='blue', alpha=0.5, s=10, label='Not Spam')
axes[1].scatter(features_pca[spam, 0], features_pca[spam, 1], 
                c='red', alpha=0.5, s=10, label='Spam')
...
# Plot 3: PC2 vs PC3
axes[2].scatter(features_pca[~spam, 1], features_pca[~spam, 2], 
                c='blue', alpha=0.5, s=10, label='Not Spam')
axes[2].scatter(features_pca[spam, 1], features_pca[spam, 2], 
                c='red', alpha=0.5, s=10, label='Spam')
